...
public:
	...
	T get(size_type i, size_type = 0, size_type = 0);
	void set(const T& value, size_type i, size_type = 0, size_type = 0);
	void assign(const T& value);
	//element access===============================

	T* getpValue(size_type i, size_type = 0, size_type = 0);  //not good
